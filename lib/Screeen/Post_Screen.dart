...
import 'package:food_app/Post_Screen_Widget/Custome_Drawer.dart';
                      ...
                      return InkWell(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => FinalItems(Image_Url: 'https://food.elms.pk/' +list[index].image.toString(),name: title_Of_Item,price: rupees,),
                              ));
                        },
                        child: Container(
                          decoration: BoxDecoration(
                          ...
                          child:urlOfImage.isEmpty?Center(child: Text('Processing',style: TextStyle(fontSize: 12,color: Colors.white),)): Image.network('https://food.elms.pk/' +list[index].image.toString()),
                        ),
                      );
                      ;
                    },
